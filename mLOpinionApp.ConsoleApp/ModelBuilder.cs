...
namespace MLOpinionApp.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\ajmal\source\repos\SinequaSentimentAnalysisDemoApp\SinequaSentimentAnalysisDemoApp\Data\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"../../../../MLOpinionApp.Model/MLModel.zip";
